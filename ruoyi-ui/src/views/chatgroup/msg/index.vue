<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否撤回" prop="isRecalled">
        <el-input
          v-model="queryParams.isRecalled"
          placeholder="请输入是否撤回"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否撤回" align="center" prop="isRecalled" />
      <el-table-column label="撤回时间" align="center" prop="recallTime" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否撤回" prop="isRecalled">
          <el-input v-model="form.isRecalled" placeholder="请输入是否撤回" />
        </el-form-item>
        <el-form-item label="撤回时间" prop="recallTime">
          <el-date-picker clearable
...
<script>
import { listMsg, getMsg, delMsg, addMsg, updateMsg } from "@/api/chatgroup/msg"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除私聊消息编号为"' + ids + '"的数据项？').then(function() {
        return delMsg(ids)
      }).then(() => {
        this.getList()
