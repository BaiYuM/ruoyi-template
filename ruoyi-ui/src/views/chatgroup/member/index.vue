<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="群聊ID" prop="groupId">
        <el-input
      ...
      <el-form-item label="个人禁言状态" prop="isMute">
        <el-input
          v-model="queryParams.isMute"
          placeholder="请输入个人禁言状态"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="memberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="群聊ID" align="center" prop="groupId" />
      <el-table-column label="成员用户ID" align="center" prop="userId" />
      <el-table-column label="成员角色" align="center" prop="roleType" />
      ...
      <el-table-column label="个人禁言状态" align="center" prop="isMute" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="群聊ID" prop="groupId">
          <el-input v-model="form.groupId" placeholder="请输入群聊ID" />
        </el-form-item>
        <el-form-item label="成员用户ID" prop="userId">
        ...
        <el-form-item label="个人禁言状态" prop="isMute">
          <el-input v-model="form.isMute" placeholder="请输入个人禁言状态" />
        </el-form-item>
...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/chatgroup/member"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        groupId: [
          { required: true, message: "群聊ID不能为空", trigger: "blur" }
        ],
        userId: [
        ...
        isMute: [
          { required: true, message: "个人禁言状态不能为空", trigger: "blur" }
        ],
        delFlag: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除群聊成员关联编号为"' + ids + '"的数据项？').then(function() {
